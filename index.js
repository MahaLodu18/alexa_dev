...
const GAME_LENGTH = 4;
const SKILL_NAME = 'Technology quiz';
const FALLBACK_MESSAGE = `The ${SKILL_NAME} skill can\'t help you with that.  It can ask you questions about Technology if you say start game. What can I help you with?`;
...
const languageString = {
  ...
  'en-US': {
    translation: {
      QUESTIONS: questions.QUESTIONS_EN_US,
      GAME_NAME: 'American Technology Quiz'
    },
  },
  'en-GB': {
    translation: {
      QUESTIONS: questions.QUESTIONS_EN_GB,
      GAME_NAME: 'British Technology Quiz'
    },
  },
  de: {
    translation: {
